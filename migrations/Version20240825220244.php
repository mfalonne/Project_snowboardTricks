 ...
 */
final class Version20240825220244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD user_id INT NOT NULL, ADD categorie_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick DROP user_id, DROP categorie_id');
    }
}
